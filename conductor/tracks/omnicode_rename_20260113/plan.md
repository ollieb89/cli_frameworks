...
- [ ] Task: Update the CLI help text and version command logic to display "OmniCode".
- [ ] Task: Update any hardcoded command strings in the `CommandRegistry` or parser.
- [ ] Task: Conductor - User Manual Verification 'CLI Entry Points & Binary Configuration' (Protocol in workflow.md)

## Phase 4: UI Components & Documentation Purge
- [ ] Task: Perform a systematic search and replace of "Gemini CLI" with "OmniCode" in all React/Ink UI components.
- [ ] Task: Update internal documentation (e.g., `GEMINI.md` to `OMNICODE.md` if necessary, and references within).
- [ ] Task: Update repository README and setup guides.
- [ ] Task: Conductor - User Manual Verification 'UI Components & Documentation Purge' (Protocol in workflow.md)
